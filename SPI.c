...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x1A,0x3B,0x5C,0x7D,0x9E}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x1A,0x3B,0x5C,0x7D,0x9E}; //发送地址
...
{  
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP ;   //推挽输出ce  pb2
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP ;   //推挽输出cs  pa4
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure); 
	GPIO_SetBits(GPIOA,GPIO_Pin_4);
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU  ;   //上拉输入irq   pb0
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
...
{
	u8 buf[5];
	u8 buf_in[5]={0x1A,0x3B,0x5C,0x7D,0x9E};
	//u8 i;
